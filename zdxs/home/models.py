...
class UserAvatar(models.Model):
	user=models.OneToOneField(User)
	avatar=models.TextField(max_length=200,default="http://7xo7gw.com1.z0.glb.clouddn.com/original_uwDd_13280000f27c113e.jpg")

class Avatar(models.Model):
	pic=models.TextField(max_length=200)